...
public class ContactDbHelper extends SQLiteOpenHelper {
    ...
    public Cursor readContacts(SQLiteDatabase database)
    {
        ...
        Cursor cursor = database.query(ContactContract.ContactEntry.TABLE_NAME, projections,null,null,null,null,null,null) ;
        return cursor;
    }
    ...
    public void deleteContact(int id, SQLiteDatabase database){
        String ContactId= ContactContract.ContactEntry.CONTACT_ID + " = "+id;
        database.delete(ContactContract.ContactEntry.TABLE_NAME, ContactId,null);
